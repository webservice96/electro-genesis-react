        ...
        <Container>
            <Row className='py-5'>
                <Col sm={{span:6,offset:3}} md={{span:8,offset:2}}>
                    <div className=' text-center'>
                        <h2 className='grand_title text-md-start'>Our use of cutting-edge technologies, highly sensitive assays, and interpretation from expert pathologists provides a level of quality that is required to accentuate the efficacy of a novel therapeutic.</h2>
                    </div>
                </Col>
            </Row>
			<Row>
			<div className="item-list-wrepper py-5">
				<ul className="list-parent-ul">
					<li className="list-item-li d-flex justify-content-between align-items-center py-4 position-relative">
						
						<div className="o-number text-center mt-0 z-index ms-3">
                            <span>01</span>
                        </div>
						<div className='title-button w-50 z-index-3'>
							<h2 className='grand_title mb-3'>TEST OFFERING</h2>
							<ReadMoreButton lable="More"/>
						</div>
						<div class="icon-svg z-index me-4">
							<svg width='120' xml:space="preserve" viewBox="0 0 200 200" y="0" x="0" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1"fill="none"stroke-width="2" stroke="black">
								
								<path d="M92.2 68.1h48.9M162.7 71.9c-4.9 4-20.6 18.5-20.6 30.2 0 12.2 9.5 15.4 13.7 15.4 4.2 0 13.7-3.3 13.7-15.4 0-11.7-16.9-28.3-21.8-32.3L65.5 152c-7.9 7.9-20.8 7.9-28.7 0-7.9-7.9-7.9-20.8 0-28.7L119 41.2" class="st0"></path>
							</svg>
						</div>
					</li>
					<li className="list-item-li d-flex justify-content-between align-items-center py-4 position-relative">
						...
						<div className='title-button w-50 z-index-3'>
							<h2 className='grand_title mb-3'>PROCESSES</h2>
							<ReadMoreButton lable="More"/>
						</div>
						<div class="icon-svg z-index me-4">
							<svg width='120' xml:space="preserve" viewBox="0 0 200 200" y="0" x="0" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1"fill="none"stroke-width="2" stroke="black">
					...
					<li className="list-item-li d-flex justify-content-between align-items-center py-4 position-relative">
						...
						<div className='title-button w-50 z-index-3'>
							<h2 className='grand_title mb-3'>ASSAY DEVELOPMENT</h2>
							<ReadMoreButton lable="More"/>
						</div>
						<div class="icon-svg z-index me-4">
							<svg width='120' xml:space="preserve" viewBox="0 0 200 200" y="0" x="0" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1"fill="none"stroke-width="2" stroke="black">
					...
					<li className="list-item-li d-flex justify-content-between align-items-center py-4 position-relative">
						...
						<div className='title-button w-50 z-index-3'>
							<h2 className='grand_title mb-3'>LOGISTICS</h2>
							<ReadMoreButton lable="More"/>
						</div>
						<div class="icon-svg z-index me-4">
							<svg width='120' xml:space="preserve" viewBox="0 0 200 200" y="0" x="0" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1"fill="none"stroke-width="2" stroke="black">
					...
					<li className="list-item-li d-flex justify-content-between align-items-center py-4 position-relative">
						...
						<div className='title-button w-50 z-index-3'>
							<h2 className='grand_title mb-3'>COMPANION DIAGNOSTICS</h2>
							<ReadMoreButton lable="More"/>
						</div>
						<div class="icon-svg z-index me-4">
							<svg width='120' xml:space="preserve" viewBox="0 0 200 200" y="0" x="0" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1"fill="none"stroke-width="2" stroke="black">
					...
					<li className="list-item-li d-flex justify-content-between align-items-center py-4 position-relative">
						...
						<div className='title-button w-50 z-index-3'>
							<h2 className='grand_title mb-3'>PROJECT MANAGEMENT</h2>
							<ReadMoreButton lable="More"/>
						</div>
						<div class="icon-svg z-index me-4">
							<svg width='120' xml:space="preserve" viewBox="0 0 200 200" y="0" x="0" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1"fill="none"stroke-width="2" stroke="black">
					...
					<li className="list-item-li d-flex justify-content-between align-items-center py-4 position-relative">
						...
						<div className='title-button w-50 z-index-3'>
							<h2 className='grand_title mb-3'>GLOBAL</h2>
							<ReadMoreButton lable="More"/>
						</div>
						<div class="icon-svg z-index me-4">
							<svg width='120' xml:space="preserve" viewBox="0 0 200 200" y="0" x="0" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1"fill="none"stroke-width="2" stroke="black">
					...
					<li className="list-item-li d-flex justify-content-between align-items-center py-4 position-relative">
						...
						<div className='title-button w-50 z-index-3'>
							<h2 className='grand_title mb-3'>REPORTING</h2>
							<ReadMoreButton lable="More"/>
						</div>
						<div class="icon-svg z-index me-4">
							<svg width='120' xml:space="preserve" viewBox="0 0 200 200" y="0" x="0" xmlns="http://www.w3.org/2000/svg" id="Layer_1" version="1.1"fill="none"stroke-width="2" stroke="black">
    
								 <path d="M102.1 136.7c5.8 4.7 11 9 11 12.6M113.1 83.1c0 9.9-26.6 19.4-26.6 33.1 0 6.8 6.6 13 13.3 18.6" class="st0"></path>
								<path d="M102.3 100.3c5.7 4.8 10.8 10 10.8 16 0 13.7-26.6 24.8-26.6 33.1M86.5 83.1c0 5 6.6 9.8 13.3 15.2" class="st0"></path>
								<path d="M84.4 47.8h-25v13.9h25.1c8.9 0 25.8-6.5 25.8-18.3 0-8.7-7.6-11-10.6-11s-10.6 2.3-10.6 11c0 11.8 16.9 18.3 25.8 18.3H140V167H59.4V70.7M141 47.8h-26.2" class="st0"></path>
							</svg>
						</div>
					</li>
				</ul>
				...
				<div className='contat_us_text bg-white border-right-runded d-flex align-items-center'>
				 <div className="left-textAnd-button w-75 mx-auto text-center">
						...
						<div className='d-flex py-5 align-items-center justify-content-evenly'>
							<ReadMoreButton lable="Contact us" setShow={setShow}/>
