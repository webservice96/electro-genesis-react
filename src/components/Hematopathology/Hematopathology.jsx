				...
				<div className="content-text-part max-width">
					...
					<Row>
						<div className="hematolog-content-box">
							...
							<div
								className="pragraph d-flex justify-content-center"
								data-aos="fade-up"
								data-aos-duration="2000"
							>
								<p className="pe-2 w-50">
									<strong>
										Acute Myeloid Leukemia (AML)
									</strong>{" "}
									is a group of diseases of the bone marrow
									...
									receptor occupancy,and minimal/measurable
									residual disease (MRD) detection for AML.
								</p>
								<p className="ps-2 w-50">
									Our AML MRD flow assay is in alignment with
									the guidelines set forth by the European
									LeukemiaNet MRD Working party. We have also
									validated a highly-sensitive, comprehensive,
									73-gene myeloid panel for AML MRD detection
									by NGS. These assays are available at all of
									our locations (US, EU, Asia-Pacific, and
									China) and have been used for multiple phase
									3 registrational clinical trials, with
									single-subject reports provided to the sites
					...
					<Row>
						<div
							className="hematolog-content-box margin-left"
							data-aos="fade-up"
							data-aos-duration="2000"
						>
							...
							<div className="pragraph d-flex justify-content-center">
								<p className="w-50 pe-2">
									...
									by flow cytometry, molecular genetics,
									histology, FISH, and cytogenetics. Some
									biomarkers include CD19, CD5, CD49d, CD47,
									Kappa, Lambda, cytoplasmic ZAP-70, as well
									as other custom biomarkers. We have
									validated multiple flow cytometry assays for
									immunophenotyping, receptor occupancy, and
								...
								<p className=" w-50 ps-2">
									...
									Asia-Pacific, and China) and have been used
									for multiple phase 3 registrational clinical
									trials, with single-subject reports provided
									to the sites to support treatment decisions.
								</p>
							</div>
						</div>
					</Row>
					<Row>
						<div
							className="hematolog-content-box mb-5"
							data-aos="fade-up"
							data-aos-duration="2000"
						>
							...
							<div className="pragraph d-flex justify-content-center">
								<p className="w-50 pe-2">
									...
									validated multiple flow cytometry assays for
									immunophenotyping, receptor occupancy,
								</p>
								...
								<p className=" w-50 ps-2">
									...
									EU, Asia-Pacific, and China) and have been
									used for multiple phase 3 registrational
									clinical trials, with single-subject reports
									provided to the sites to support treatment
									decisions.
								</p>
							</div>
						</div>
