		...
		<>
			<Modal show={show} onHide={handleClose}>
					...
					>
						<span>
							<svg
								...
								className="desktop-icon icon-svg"
							>
								<line
									x1="2.06066"
									y1="1"
				...
				<div className="modal-bodys">
					<div className="users-Image mt-3">
						<img
							className=""
						...
						/>
						<h3 className="subtitle">Here's how you can reach us.</h3>
					...
					<div className="check-uot">
						<div className=" w-50 m-auto">
							<span className="checkbox-btn-wrapper">
								...
								<span className="label">
									I consent to having this site collect my
									personal data.{" "}
									<a
										href="/legal/privacy-policy-and-cookies"
										target="_blank"
