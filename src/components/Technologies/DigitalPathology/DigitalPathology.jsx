        ...
        <div className='content-text-part max-width mb-5'>
          ...
          <Row >
            <Col md={{span:4,offset:0}}>
              <p>Hematogenix employs the latest technologies in machine learning and computerized algorithms to navigate the complex interpretation of digital images.</p>
              <p>The goal is to be a leader in this new era of modern pathology practice and enable our partners to utilize these technologies in gathering and analyzing biomarker data from tumor tissue.</p>
            </Col>
             <Col md={{span:7,offset:1}}>
              <div className="flowcy_image-box margin-top-lass">
                <img src='/assets/img/technology/analysis.png' alt="image" />
              </div>
            </Col>
          </Row>
