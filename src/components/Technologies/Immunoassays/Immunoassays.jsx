          ...
          <Row >
             <Col md={5}>
              <div className="flowcy_image-box">
                <img src='/assets/img/technology/roche-cobas.png' alt="image" />
                <div className="image-caption mb-1">
                  <span className='pt-0'>Roche Cobas 601</span>
                </div>
              </div>
            </Col>
            
            <Col md={{span:6,offset:1}}>
              <h3 className="flowcy_description">Fully Automated Systems Are Available to Support a Broad Range of Applications</h3>

              <p className='mt-5 pe-5'>Hematogenix® offers an extensive test menu for the measurement of antibodies, proteins, cytokines/chemokines, metabolites, and other chemical compounds.</p>
            </Col>
          </Row>
            ...
            <Col md={{span:4,offset:0}}>
             ...
             <Col md={8}>
              <Row>
                ...
                <Col md={{span:4,offset:0}}>
                <div className="flowcy_image-box">
                  <img src='/assets/img/technology/roche-cobas-2.png' alt="image" />
            ...
            <Col md={{span:4,offset:0}}>
             ...
             <Col md={8}>
              <Row>
                <Col md={{span:4}}>
                <div className="flowcy_image-box">
                  <img src='/assets/img/technology/meso-quick.png' alt="image" />
                  <div className="Platforms-img-caption image-caption">
            ...
            <Col md={{span:4,offset:0}}>
             ...
             <Col md={8}>
              <Row>
                <Col md={{span:4}}>
                <div className="flowcy_image-box">
                  <img src='/assets/img/technology/sebia.png' alt="image" />
                  <div className="Platforms-img-caption image-caption">
            ...
            <Col md={{span:4,offset:0}}>
             ...
             <Col md={{span:4,offset:3}}>
                <ul className="underline-text margin-top-lass">
                    <li className="underline-item mb-3 pb-3">
                        <div>Quantitative and Qualitative Immunological Analysis (100+ Assays)</div>
                    </li>
                    <li className="underline-item mb-3 pb-3">
                        <div>High-Sensitivity, Multiplex Cytokine/Chemokine Assays</div>
                    </li>
                    <li className="underline-item mb-3 pb-3">
                      <div>Protein Electrophoresis & Immunofixation</div>
                      </li>
                    <li className="underline-item mb-3 pb-3">
            ...
            <Col md={{span:4,offset:0}}>
             ...
             <Col md={{span:4,offset:2}}>
                <Row className="list margin-top-lass">
                    ...
                    <Col xs={6} className="column item">
                        <div className="inner"><span className="label">Serum</span></div>
                    </Col>
                    <Col xs={6} className="column item">
                        <div className="inner"><span className="label">Plasma</span></div>
                    </Col>
                    <Col xs={6} className="column item">
                        <div className="inner"><span className="label">Urine</span></div>
                    </Col>
                </Row>
             </Col>
          </Row>
