					...
					<Row>
						...
						>
							<div className="flowcy_image-box margin-top-lass">
								<img
									src="/assets/img/technology/technology-2.png"
									alt="image"
								/>
							</div>
						</Col>
							...
							<Row>
								...
								>
									<div className="flowcy_image-box">
										<img
											src="/assets/img/technology/technology-3-1.png"
											alt="image"
										/>
								...
								>
									<div className="flowcy_image-box">
										<img
											src="/assets/img/technology/technology-3-2.png"
											alt="image"
										/>
								...
								>
									<div className="flowcy_image-box">
										<img
											src="/assets/img/technology/technology-3-3.png"
											alt="image"
										/>
										<div className="image-caption Platforms-img-caption">
											<span>Navios EX (10 color)</span>
						...
						>
							<Row>
								...
								>
									<div className="flowcy_image-box">
										<img
											src="/assets/img/technology/technology-3-4.png"
											alt="image"
										/>
										<div className="Platforms-img-caption image-caption">
											<span>
												BD FACSCanto II Cell
												<br /> Analyzer (8 color)
											</span>
										</div>
									</div>
								...
								>
									<div className="flowcy_image-box">
										<img
											src="/assets/img/technology/technology-3-5.png"
											alt="image"
										/>
										<div className="image-caption Platforms-img-caption">
					...
					<Row className="pb-5">
						...
						>
							<p>
								...
								combinations that can be crafted specifically
			...
			<section className="block-inner Sample-type-section">
				...
				<div className="content-text-part max-width">
					<Row className="pb-5">
						...
						>
							<p className="pt-5">
								Our assays are validated with the appropriate
								specimen types based on the disease indication.
								Our scientific experts can help you determine
								the most appropriate sample type and assay for
								your clinical trial.
							</p>
						</Col>
						<Col
