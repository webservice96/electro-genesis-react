							...
							<ul className="ul-list w-75 mx-auto">
								<li className="item">
									...
									<span className="label">
										Single subject/patient reports provided
										to Principle Investigators and/or
										Sponsors
									</span>
								</li>
								<li className="item">
									...
									<span className="label">
										Cumulative data reporting via 21 CFR
										Part 11 compliant databases
									</span>
								</li>
								<li className="item">
									<svg
									...
									<span className="label">
										Final bioanalytical study reports
									</span>
								</li>
							</ul>
						</Col>
