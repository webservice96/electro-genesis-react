...
function Global() {
  return (
    ...
    <div className='block-inner'>
        <ClinicalPageHeader title={'GLOBAL'}/>
        ...
        <Row>
            <Col md={{span:5,offset:2}}>
                <div className="text-content pe-0 ms-3">
                    <p>The global demand on the pharmaceutical industry to develop drugs at a rapid pace continues to increase. It is our vision to continue to support your efforts by providing access to top scientists and high-quality testing services at each of our facilities around the world. Hematogenix® operates four locations.</p>
                </div>
            </Col>
             <Col md={{span:5,offset:0}}>
                <div className="image-div mb-3 ">
                    <img className='rounded-3 w-75 mx-auto' src="/assets/img/clinical/global.png" alt="madecin test" />
                </div>
